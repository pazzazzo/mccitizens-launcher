...
export default defineConfig([
  ...
  { files: ["src/*.{js,mjs,cjs}"], plugins: { js }, extends: ["js/recommended"], languageOptions: { globals: {...globals.browser, lucide: "readonly", skinview3d: "readonly", electronAPI: "readonly"}, sourceType: "module" } },
